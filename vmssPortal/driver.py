...
for windows_image in windows_images:
    Popen(["/usr/local/lib/python2.7.9/bin/python", "/home/negat/repos/templates/vmssPortal/run_single.py", windows_image, "password", NAMING_INFIX + "".join(windows_image.split("-")), 'w', '>', 'output/' + windows_image + auth_type + 'debug.txt'])
